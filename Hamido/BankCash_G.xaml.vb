...
Public Class BankCash_G
    ...
    Private Sub LoadWFH()
        ...
        If (Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.Hamido OrElse Md.MyProjectType = ProjectType.X27) AndAlso (Flag = 2 OrElse Flag = 4) Then
