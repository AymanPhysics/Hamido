...
Br:
    ...
    Private Sub PrintPone(ByVal sender As System.Object, ByVal NewItemsOnly As Integer)
        ...
        If NewItemsOnly = 0 Then
            ...
            rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X0, "SalesPone_N.rpt", "SalesPone.rpt")
            'If sender Is btnPrint2 Then rpt.Rpt = "SalesPone2.rpt"
            If sender Is btnPrint3 Then rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X0, "SalesPone3_N.rpt", "SalesPone3.rpt")
