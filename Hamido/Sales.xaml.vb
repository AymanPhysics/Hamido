...
Public Class Sales
    ...
    Public Sub Sales_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If Not (Md.MyProjectType = ProjectType.X0 AndAlso Flag = FlagState.مشتريات) Then
        ...
        End If
        If Md.MyProjectType = ProjectType.X0 AndAlso Flag = FlagState.المبيعات Then
    ...
    Private Sub LoadWFH()
        ...
        If Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X28 Then
        ...
        If Md.MyProjectType = ProjectType.X0 AndAlso Flag = FlagState.تحويل_إلى_مخزن Then
    ...
    Function ReadOnlyState() As Boolean
        If Md.MyProjectType = ProjectType.X0 AndAlso (Flag = FlagState.تسوية_صرف OrElse Flag = FlagState.صرف) Then
            Return True
    ...
    Function ItemWhere() As String
        ...
        If Md.MyProjectType = ProjectType.X0 AndAlso TestSalesAndReturn() Then
...
Br:
            ...
            If (Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.Hamido) AndAlso (Flag = FlagState.إضافة OrElse Flag = FlagState.مشتريات OrElse Flag = FlagState.الاستيراد OrElse Flag = FlagState.تحويل_إلى_مخزن OrElse Flag = FlagState.المبيعات) Then
                If i = 0 Then
                    Dim x As Integer = 1
                    Select Case Flag
                        Case FlagState.تحويل_إلى_مخزن
    ...
    Sub CalcRow(ByVal i As Integer)
        Try
            ...
            If Not lop AndAlso (Flag = FlagState.المبيعات OrElse Flag = FlagState.مردودات_مشتريات OrElse Flag = FlagState.مردودات_مشتريات_خارجية OrElse Flag = FlagState.تحويل_إلى_مخزن OrElse Flag = FlagState.عرض_أسعار OrElse Flag = FlagState.أمر_توريد OrElse Flag = FlagState.صرف OrElse Flag = FlagState.تسوية_صرف) AndAlso Val(G.Rows(i).Cells(GC.Qty).Value) > Val(G.Rows(i).Cells(GC.CurrentBal).Value) Then
                ...
                End If
                If Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.X26 Then
    ...
    Private Sub ToId_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles ToId.LostFocus
        ...
        If Md.MyProjectType = ProjectType.X0 And TestSalesAndReturn() And Not lop Then
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Md.MyProjectType = ProjectType.X0 AndAlso DocNo.Text.Trim = "" Then
...
Print:
        ...
        If sender Is btnPrint OrElse sender Is btnPrint2 OrElse sender Is btnPrint3 OrElse sender Is btnPrint4 OrElse sender Is btnPrint5 OrElse sender Is btnPrintImage OrElse sender Is btnPrintSafe OrElse (sender Is btnCloseTable And btnPrint.IsEnabled) Then
            PrintPone(sender, 0)
            If Md.MyProjectType = ProjectType.X0 AndAlso sender Is btnPrint AndAlso Flag = FlagState.المبيعات Then
    ...
    Sub ClearControls()
        Try
            ...
            If Md.MyProjectType <> ProjectType.X12 AndAlso Md.MyProjectType <> ProjectType.X2 AndAlso Md.MyProjectType <> ProjectType.X3 AndAlso Md.MyProjectType <> ProjectType.X0 Then CashierId.Text = Md.UserName
            ...
            Temp2.Visibility = Windows.Visibility.Hidden
            Temp2.IsChecked = True
            If Md.MyProjectType = ProjectType.X0 And TestImportOnly() Then
            ...
            If Not Md.Manager Then
                ...
                If Not Md.MyProjectType = ProjectType.X0 Then CashierId.Text = Md.UserName
                CashierId_LostFocus(Nothing, Nothing)
            Else
        ...
        If TestSalesAndReturn() AndAlso Md.MyProjectType = ProjectType.X0 Then
    ...
    Private Sub PrintPone(ByVal sender As System.Object, ByVal NewItemsOnly As Integer)
        ...
        If TestSalesAndReturn() OrElse TestPurchaseAndReturn() Then
            Select Case Md.MyProjectType
                Case ProjectType.X0, ProjectType.X28
        ...
        If NewItemsOnly = 0 Then
            ...
            Select Case Md.MyProjectType
                ...
                Case Else
                    ...
                    ElseIf Md.MyProjectType = ProjectType.X9 Then
            ...
            If sender Is btnPrint3 AndAlso Md.MyProjectType = ProjectType.Hamido Then rpt.Rpt = "SalesPone3_H.rpt"
            If sender Is btnPrint3 AndAlso Md.MyProjectType = ProjectType.X27 Then rpt.Rpt = "SalesPone3_O.rpt"

            If sender Is btnPrint4 Then rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X0, "SalesPone4_N.rpt", "SalesPone4.rpt")
            If sender Is btnPrintSafe Then rpt.Rpt = "SalesPonePrintSafe.rpt"

            If sender Is btnPrint2 Then
                Dim i As Integer = 1
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X0, "SalesPone2_N.rpt", "SalesPone2.rpt")
            ...
            If Md.MyProjectType = ProjectType.X0 AndAlso sender Is btnPrint Then
                rpt.ShowDialog()
            Else
                rpt.Show()
            End If
    ...
    Private Sub LoadVisibility()
        ...
        ElseIf TestSalesAndReturn() OrElse TestExportAndReturn() Then
            ...
            If Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.Hamido OrElse Md.MyProjectType = ProjectType.X24 Then
                lblDeliveryDate.Visibility = Windows.Visibility.Visible
                DeliveryDate.Visibility = Windows.Visibility.Visible
                If Md.MyProjectType = ProjectType.X0 Then
            ...
            If Not (Md.MyProjectType = ProjectType.X5 OrElse Md.MyProjectType = ProjectType.X6 OrElse Md.MyProjectType = ProjectType.X21 OrElse Md.MyProjectType = ProjectType.X23 OrElse Md.MyProjectType = ProjectType.X0) Then
        ...
        If (Md.MyProjectType = ProjectType.X22 OrElse Md.MyProjectType = ProjectType.X27) AndAlso TestSalesOnly() AndAlso Flag <> FlagState.عرض_أسعار AndAlso Flag <> FlagState.أمر_توريد Then
        ...
        If Md.MyProjectType = ProjectType.X14 OrElse Flag = FlagState.عرض_أسعار OrElse Flag = FlagState.أمر_توريد OrElse Flag = FlagState.أمر_شراء OrElse Flag = FlagState.عرض_أسعار_مورد Then
        ...
        If (Md.MyProjectType = ProjectType.X0 OrElse Md.MyProjectType = ProjectType.Hamido) AndAlso Flag <> FlagState.مشتريات AndAlso Flag <> FlagState.مردودات_مشتريات AndAlso Flag <> FlagState.مشتريات_خارجية AndAlso Flag <> FlagState.مردودات_مشتريات_خارجية AndAlso Flag <> FlagState.الاستيراد AndAlso Flag <> FlagState.مردودات_الاستيراد Then
            DocNo.Visibility = Visibility.Hidden
            lblDocNo.Visibility = Visibility.Hidden
        End If
    ...
    Private Sub DocNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles DocNo.KeyUp
        If Not (Md.MyProjectType = ProjectType.X0 AndAlso TestPurchaseOnly()) Then Return
