...
Public Class BankCash_G2
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        For i As Integer = 0 To G1.Rows.Count - 1
            ...
            If Md.MyProjectType = ProjectType.X0 AndAlso G1.Columns(GC.CostTypeId).Visible AndAlso Val(G1.Rows(i).Cells(GC.LinkFile).Value) = 9 AndAlso Val(G1.Rows(i).Cells(GC.CostTypeId).Value) = 0 Then
    ...
    Private Sub GridCalcRow(ByVal sender As Object, ByVal e As Forms.DataGridViewCellEventArgs)
        ...
        If lop Then Return
        Try
            If Md.MyProjectType = ProjectType.X0 AndAlso e.RowIndex < G.Rows.Count - 1 AndAlso Val(G.Rows(e.RowIndex).Cells(GC.DocNo).Value) = 0 Then
