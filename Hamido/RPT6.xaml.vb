...
Public Class RPT6
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        Select Case Detail
            Case 0
                ...
                End If
            Case 1
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X0, "Sales_N.rpt", "Sales.rpt")
                ...
                End If
            Case 2
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X0, "DeletedSales_N.rpt", "DeletedSales.rpt")
            Case 3
                rpt.Rpt = "ItemsSales5.rpt"
            Case 4
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X0, "SalesProfit_N.rpt", "SalesProfit.rpt")
            ...
            Case 7
                ...
                ElseIf Md.MyProjectType = ProjectType.X0 Then
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        If (Flag = 3 OrElse Flag = 30 OrElse Flag = 9 OrElse Flag = 31 OrElse Flag = 28) AndAlso (Detail = 0 OrElse Detail = 1) Then
            ...
            If Md.MyProjectType = ProjectType.X22 AndAlso (Flag = 3 OrElse Flag = 30) Then
